...
Use this checklist before cutting a public release for connector-fixture-story-skill.
...
- Exercise the CLI smoke path for `connector-fixture-story-skill` with the checked-in fixture.
